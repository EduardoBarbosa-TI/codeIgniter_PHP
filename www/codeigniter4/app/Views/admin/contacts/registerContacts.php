<div class=" col-12 col-sm-12 my-5 ms-2">
    ...
    <form class="row g-3" method="POST" action="<?=base_url('admin/contact/register')?>">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <label for="validationDefault02" class="form-label">Mensagem</label>
            <input type="text" class="form-control" name="message" id="validationDefault02" required>
        </div>
        <div class="col-md-12">
